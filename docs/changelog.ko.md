2.11.2
-----
 * 수정: (16.x/jgrpp-0.72.0 이상 버전에서) '열차가 회차할 때 열차 전체가 뒤집히는 것을 허용' 설정을 '불가능'으로 한 경우, 기관차의 진행 방향에 따라 일부 기관차의 전조/후미등이 올바르게 표시되지 않는 현상 [#507]
 * 수정: 유조차가 FIRS 5.x.x의 산소를 실을 수 없음 [#510]
